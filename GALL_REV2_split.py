...
pdf_file = r"C:\Users\celin\Downloads\ML103490041.pdf"
split_pdf_folder = r"C:\Users\celin\Downloads\GALL AMPs"
word_folder = r"C:\Users\celin\Downloads\GALL AMPs"
...
for i, page in enumerate(reader.pages[20:], start=20):
    ...
    match = re.search(r"(XI E\d+[A-Z]?)-\d+", text)
